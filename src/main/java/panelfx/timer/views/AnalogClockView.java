 ...
 * @author ohlsen
 */
public class AnalogClockView extends javax.swing.JPanel implements ClockView {
    ...
    public void paintComponent(final Graphics g) {
        ...
        final double angleD = -(360.0 / this.getSecondsTotal()) * (this.getSecondsTotal() - this.getSecondsLeft());
        final int angle = (int) Math.round(angleD);
        final int startAngle = 90;
        final int angleInt = Math.round(angle);

        g2d.setColor(new Color(210, 210, 210));
        g2d.fillArc(33, 40, 100, 100, startAngle, angle);
        g2d.setColor(Color.darkGray);
        g2d.drawOval(33, 40, 100, 100);
    }
